...
The site is a static single page built with Bootstrap, custom CSS, and vanilla JavaScript. There is no package manager or build step.
...
Bootstrap 5.3.8 is loaded from jsDelivr. The site supports light and dark themes, remembers the visitor's choice, and follows the system preference on the first visit.
